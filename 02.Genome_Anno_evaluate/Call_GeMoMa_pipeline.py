...
mmseq_path = '/ldfssz1/ST_EARTH/Reference/ST_DIVERSITY/USER/panyouliang/miniconda3/bin/'
...
def extractor():
    ...
    with open(args.homolog_list,'r') as f:
        for line in f:
            ...
            Extract = [run_java,'-Xms20G','-Xmx400G','-jar',GeMoMa,'CLI','Extractor','a='+gff,'g='+genome, 'd=false','f=false','p=true','c=true','r=true','outdir='+'extractor_data/'+sp]
...
def Pipeline():
    ...
    run_feature.write('source /ldfssz1/ST_EARTH/Reference/ST_DIVERSITY/USER/panyouliang/miniconda3/etc/profile.d/conda.sh\n')
