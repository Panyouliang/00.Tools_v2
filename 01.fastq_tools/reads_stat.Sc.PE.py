...
parser.add_argument('--fqI', metavar='fastq',type=str,required=True,help='Please input the fastq(gzip) format')
...
fqI,fq1,fq2,sample,land=[args.fqI,args.fq1,args.fq2,args.sample,args.land]
...
rI_len,rI_reads,rI_total,gcI_rate,maxI_read_len,minI_read_len = get_main(rI)

#max_len = get_than1(max1_read_len,max2_read_len)
#min_len = get_than2(min1_read_len,min2_read_len)

r1_length = r1_len / r1_reads
r2_length = r2_len / r2_reads
rI_length = rI_len / rI_reads


print(sample, land, r1_length, r2_length, rI_length, r1_reads + r2_reads + rI_reads, r1_total, r2_total, rI_total, r1_total + r2_total + rI_total, format((gc1_rate + gc2_rate + gcI_rate)/2,'.3f'), sep='\t')
